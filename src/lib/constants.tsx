...
export const PLANT_CATEGORIES: PlantCategories[] = [
  {
    ...
    image: <img alt="fruit trees" src="/images/olirum.png" className="w-full h-full" />,
    description: `Deciduous trees and shrubs seasonally shed leaves, petals, after flowering & ripe fruit.`,
    key: 'deciduous'
  },
  {
    name: 'Timber trees - ',
    image: <img alt="shrubs" src="/images/olirum.png" className="w-full h-full" />,
...
export const SOUTH_INDIA_TREES: PlantSpecies[] = [
  {
    ...
    image: <img alt="sarakkonrai" src="/images/sarakkonrai.jpg" className="w-full h-full hover:scale-150 transition-all duration-1000 ease-out" />,
    description: `TDEF also has some species of Shrubs which can tolerate 
    high tempatures and at the same time drought`,
  ...
  },
  {
    ...
    image: <img alt="shrubs" src="/images/olirum.png" className="w-full h-full" />,
    description: `An evergreen shrub. A drough tolerant tree 
    with beautiful foliage`,
