...
export const DRAVIDIAN_TREES: PlantSpecies[] = [
  {
    id: 'sarakkonrai',
    name: 'Cassia fistula',
    ...
    imageNoZoom: <img alt="sarakkonrai" src="/images/sarakkonrai.jpg" className="aspect-[1]" />,
    description: `TDEF also has some species of Shrubs which can tolerate 
    high tempatures and at the same time drought`,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="naval" src="/images/naval.jpg" className="aspect-[1]" />,
    description: `TDEF also has some species of Shrubs which can tolerate 
    high tempatures and at the same time drought`,
    keywords: ['பழ', 'நடுத்தர'],
    href: '/naaval'
  },
  {
    ...
    imageNoZoom: <img alt="semmaram" src="/images/semmaram.jpeg" className="aspect-[1]" />,
  ...
  // },
  {
    ...
    image: <img alt="kuthirapidukkan" src="/images/kuthirapidukkan.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="kuthirapidukkan" src="/images/kuthirapidukkan.jpg" className="aspect-[1]" />,
  ...
  // },
  {
    ...
    image: <img alt="nuraipungan" src="/images/nuraipungan-full.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="nuraipungan" src="/images/nuraipungan-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="pachainazhuvai" src="/images/pachainazhuvai-fruit.jpg" className="aspect-[1]" />,
    description: `Fast growing medium sized evergreen tree. A drough tolerant tree 
    with beautiful foliage`,
  ...
  },
  {
    ...
    image: <img alt="vennaghu" src="/images/vennaghu.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="vennaghu" src="/images/vennaghu.jpg" className="aspect-[1]" />,
    description: `Fast growing medium sized evergreen tree. A drough tolerant tree 
    with beautiful foliage`,
  ...
  },
  {
    ...
    image: <img alt="kakkaipazhai" src="/images/kakkaipazhai-full.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="kakkaipazhai" src="/images/kakkaipazhai-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    image: <img alt="irumpuli" src="/images/irumpuli.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="irumpuli" src="/images/irumpuli.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    image: <img alt="neerkadambai" src="/images/neerkadambai.png" className="img-zoom" />,
    imageNoZoom: <img alt="neerkadambai" src="/images/neerkadambai.png" className="aspect-[1]" />,
    description: `TDEF also has some species of Shrubs which can tolerate 
    high tempatures and at the same time drought`,
  ...
  },
  {
    ...
    tamil_name: 'ஆச்சா',
    image: <img alt="aacha" src="/images/aacha-full.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="aacha" src="/images/aacha-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    tamil_name: 'தாரனி',
    image: <img alt="thaarani" src="/images/thaarani-full.jpg" className="img-zoom" />,
    imageNoZoom: <img alt="thaarani" src="/images/thaarani-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="vaalsaram" src="/images/vaalsaram-full.jpeg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="kaasaan" src="/images/kaasaan.png" className="aspect-[1]" />,
  ...
  },
  {
    ...
    tamil_name: 'கணுப்பலா',
    image: <img alt="kanupala" src="/images/kanupala-full.png" className="img-zoom" />,
    imageNoZoom: <img alt="kanupala" src="/images/kanupala-full.png" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="aavarai" src="/images/aavarai-full.jpeg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="veerai" src="/images/veerai-fruits.jpeg" className="aspect-[1]" />,
    description: `A medium sized evergreen tree. Tree is drough tolerant, has evergreen foliage
    and is slow growing.`,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="konjhi" src="/images/konjhi-fruits.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="vaagai" src="/images/vaagai-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="neermaruthu" src="/images/neermaruthu-full.jpeg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="eeti" src="/images/eeti-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="karumaruthu" src="/images/karumaruthu-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="pinnai" src="/images/pinnai-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="kaatuezhumichai" src="/images/kaatuezhumichai.jpeg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="kaatuiluppai" src="/images/kaatuiluppai-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="maghilam" src="/images/maghilam-full.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="kuttipazha" src="/images/kuttipazha.jpg" className="aspect-[1]" />,
  ...
  // },
  {
    ...
    imageNoZoom: <img alt="konghilavam" src="/images/konghilavam-flower.jpg" className="aspect-[1]" />,
  ...
  },
  {
    ...
    imageNoZoom: <img alt="karungali" src="/images/karungali.jpg" className="aspect-[1]" />,
